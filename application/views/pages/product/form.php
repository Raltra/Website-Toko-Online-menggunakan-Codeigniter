        ...
        <div class="card">
            ...
            <?= form_open_multipart($form_action, ['method' => 'POST']) ?>
                ...
                <div class="form-group">
                    ...
                    <?= form_textarea(['name' => 'description', 'class' => 'form-control', 'row' => 4, 'value' => $input->description]) ?>
                    <?= form_error('description') ?>
                </div>
                <div class="form-group">
                    <label for="">Harga</label>
                    <?= form_input('price', $input->price, ['type' => 'number', 'class' => 'form-control', 'required' => true]) ?>
                    <?= form_error('price') ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <?php endif ?>
                    <?php if($input->image): ?>
                        <img src="<?= base_url($input->image) ?>" height="150">
                    <?php endif ?>
                </div>
                <div class="form-group">
